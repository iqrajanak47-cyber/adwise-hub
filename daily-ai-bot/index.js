...
async function generateDailyPost() {
    console.log('🤖 Daily AI Bot Starting...');
...
<body>
    ...
    try {
        ...
        if (result.success) {
            console.log(`🌐 Also uploaded to website: ${result.url}`);
        }
    } catch (error) {
        console.log('ℹ️  Upload skipped (API not ready)');
    }
    
    console.log('🎉 Daily AI Bot completed!');
}
