...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (footer && !footer.querySelector('.affiliate-disclosure')) {
    ...
    disclosure.innerHTML = '<p><strong>Affiliate Disclosure:</strong> Advise Hub contains affiliate links. We may earn a commission when you click on or make purchases via our affiliate links, at no additional cost to you.</p>';
